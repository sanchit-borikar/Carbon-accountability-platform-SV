...
import PredictiveModelingPage from "./pages/dashboard/PredictiveModelingPage";
...
function RedirectOnRefresh() {
  ...
  useEffect(() => {
    // Redirect to home landing page on page refresh
    ...
    <>
      ...
      <Routes>
        ...
        <Route path="/dashboard" element={<ProtectedRoute><DashboardLayout /></ProtectedRoute>}>
          ...
          <Route path="companies/:city" element={<CompanyDetailPage />} />
          <Route path="analytics" element={<AnalyticsPage />} />
          <Route path="predictive" element={<PredictiveModelingPage />} />
